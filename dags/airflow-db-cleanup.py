...
DATABASE_OBJECTS = [
    ...
    },
    {
        ...
        "age_check_column": TaskInstance.run_id, #TaskInstance.execution_date,
        "keep_last": False,
        "keep_last_filters": None,
        "keep_last_group_by": None
    },
    ...
    },
    {
        ...
        "age_check_column": XCom.timestamp, #XCom.execution_date,
        "keep_last": False,
        "keep_last_filters": None,
        "keep_last_group_by": None
    },
...
try:
    ...
    DATABASE_OBJECTS.append({
        ...
        "age_check_column": TaskReschedule.run_id, #TaskReschedule.execution_date,
        "keep_last": False,
        "keep_last_filters": None,
        "keep_last_group_by": None
    })
...
try:
    ...
    DATABASE_OBJECTS.append({
        ...
        "age_check_column": RenderedTaskInstanceFields.run_id, #RenderedTaskInstanceFields.execution_date,
        "keep_last": False,
        "keep_last_filters": None,
        "keep_last_group_by": None
    })
